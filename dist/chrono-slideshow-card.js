import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";import{repeat}from"https://unpkg.com/lit@2.0.0/directives/repeat.js?module";import jsyaml from"https://cdn.jsdelivr.net/npm/js-yaml@4/+esm";const CARD_VERSION="0.0.16",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cSLIDESHOW%c-CARD %c v0.0.16 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DEFAULT_ITEM={_id:"",show:!0,horizontal:"center",vertical:"middle",icon:"",show_state:!1,font_color:"",font_size:1.2,font_weight:600,line_height:1.2,border_radius:50,background_color:"",padding_top:10,padding_bottom:10,padding_left:10,padding_right:10,text_shadow_color:"",text_shadow_blur:0,text_shadow_offset_x:0,text_shadow_offset_y:0,text_shadow_stroke_width:0,text_shadow_layers:2},DEFAULT_ENTITY_ITEM={...DEFAULT_ITEM,entity:""},DEFAULT_TEMPLATE_ITEM={...DEFAULT_ITEM,template:""},DEFAULT_ZONE_MODES={"top-left":"static","top-center":"static","top-right":"static","middle-left":"dynamic","middle-center":"dynamic","middle-right":"dynamic","bottom-left":"static","bottom-center":"static","bottom-right":"dynamic"},REFERENCE_HEIGHT_PX=400,EDITOR_PREVIEW_ASPECT_RATIO="16 / 10";function isInsideEditDialog(t){let e=t;for(;e;){if("HA-DIALOG"===e.tagName)return!0;e=e.parentElement||e.getRootNode()?.host}return!1}const DEFAULT_CONFIG={entity:"sensor.",sort_by:"filename",sort_reverse:!1,display_time:8,transition:"fade",transition_duration:.6,fit_mode:"contain",zone_modes:{...DEFAULT_ZONE_MODES},items:[]},NUMERIC_ITEM_KEYS=new Set(["font_size","font_weight","line_height","border_radius","padding_top","padding_bottom","padding_left","padding_right","text_shadow_blur","text_shadow_offset_x","text_shadow_offset_y","text_shadow_stroke_width"]),UI_ITEM_KEYS=new Set(["_id","show","entity","template","horizontal","vertical","icon","show_state","font_color","font_size","font_weight","line_height","border_radius","background_color","padding_top","padding_bottom","padding_left","padding_right","text_shadow_color","text_shadow_blur","text_shadow_offset_x","text_shadow_offset_y","text_shadow_stroke_width"]),UI_CARD_KEYS=new Set(["type","entity","sort_by","sort_reverse","display_time","transition","transition_duration","fit_mode","zone_modes","items"]),VERTICAL_OPTIONS=[{label:"Top",value:"top"},{label:"Middle",value:"middle"},{label:"Bottom",value:"bottom"}],HORIZONTAL_OPTIONS=[{label:"Left",value:"left"},{label:"Center",value:"center"},{label:"Right",value:"right"}],SORT_BY_OPTIONS=[{label:"Filename",value:"filename"},{label:"File date/time",value:"filedatetime"},{label:"Capture date/time",value:"exifdatetime"},{label:"Random",value:"random"}],TRANSITION_OPTIONS=[{label:"Fade",value:"fade"},{label:"Slide left",value:"slide-left"},{label:"Slide right",value:"slide-right"},{label:"Slide up",value:"slide-up"},{label:"Slide down",value:"slide-down"},{label:"Curtain",value:"curtain"},{label:"Clock",value:"clock"},{label:"None",value:"none"}],FIT_MODE_OPTIONS=[{label:"Cover",value:"cover"},{label:"Contain",value:"contain"},{label:"Fill",value:"fill"}],ZONE_MODE_OPTIONS=[{label:"Static",value:"static"},{label:"Dynamic",value:"dynamic"}],SHOW_ITEM_POSITION_BADGES=!1,VERTICAL_BADGE_COLORS={top:"#ac00ac",middle:"#c77c00",bottom:"#0600ff"},HORIZONTAL_BADGE_COLORS={left:"#bb9e00",center:"#10a800",right:"#00a896"},GROUP_DIVIDER_COLOR="#009ac7",_GROUP_DEFS=[{vertical:"top",horizontal:"left",label:"Top · Left"},{vertical:"top",horizontal:"center",label:"Top · Center"},{vertical:"top",horizontal:"right",label:"Top · Right"},{vertical:"middle",horizontal:"left",label:"Middle · Left"},{vertical:"middle",horizontal:"center",label:"Middle · Center"},{vertical:"middle",horizontal:"right",label:"Middle · Right"},{vertical:"bottom",horizontal:"left",label:"Bottom · Left"},{vertical:"bottom",horizontal:"center",label:"Bottom · Center"},{vertical:"bottom",horizontal:"right",label:"Bottom · Right"}],_GROUP_ORDER=_GROUP_DEFS.map(t=>`${t.vertical}-${t.horizontal}`);function sortItems(t){const e=t=>`${t.vertical??"middle"}-${t.horizontal??"center"}`;return[...t].sort((t,i)=>_GROUP_ORDER.indexOf(e(t))-_GROUP_ORDER.indexOf(e(i)))}function generateId(t=[]){const e=new Set(t.map(t=>t._id));let i;do{i=Math.random().toString(16).slice(2,10)}while(e.has(i));return i}function migrateConfig(t){let e=!1;if(t.items?.some(t=>!t._id)){const i=[];for(const e of t.items)i.push(e._id?e:{...e,_id:generateId(t.items.concat(i))});t={...t,items:i},e=!0}const i=t.zone_modes??{};return Object.keys(DEFAULT_ZONE_MODES).some(t=>!(t in i))&&(t={...t,zone_modes:{...DEFAULT_ZONE_MODES,...i}},e=!0),{config:t,migrated:e}}function serializeExtrasToYaml(t,e){const i={};for(const[o,s]of Object.entries(t))e.has(o)||(i[o]=s);if(!Object.keys(i).length)return"";try{return jsyaml.dump(i,{indent:2}).trimEnd()}catch(t){return""}}function parseYamlExtras(t){const e=(t??"").trim();if(!e)return{};try{const t=jsyaml.load(e);return t&&"object"==typeof t&&!Array.isArray(t)?t:null}catch(t){return null}}function fireEvent(t,e,i={},o={}){const s=new Event(e,{bubbles:o.bubbles??!0,cancelable:Boolean(o.cancelable),composed:o.composed??!0});return s.detail=i,t.dispatchEvent(s),s}function navigate(t,e={}){e.replace?history.replaceState(null,"",t):history.pushState(null,"",t),fireEvent(window,"location-changed",{replace:e.replace??!1})}function toggleEntity(t,e){e&&t.callService("homeassistant","toggle",{entity_id:e})}function handleAction(t,e,i,o){let s;switch("double_tap"===o&&i.double_tap_action?s=i.double_tap_action:"hold"===o&&i.hold_action?s=i.hold_action:"tap"===o&&i.tap_action&&(s=i.tap_action),s||(s={action:"none"}),s.action){case"none":default:break;case"more-info":fireEvent(t,"hass-more-info",{entityId:s.entity??i.entity});break;case"navigate":s.navigation_path&&navigate(s.navigation_path,{replace:s.navigation_replace});break;case"url":s.url_path&&window.open(s.url_path,"_blank");break;case"toggle":toggleEntity(e,i.entity);break;case"perform-action":case"call-service":{const t=s.perform_action??s.service;if(!t)break;const[i,o]=t.split(".",2);if(!i||!o)break;e.callService(i,o,s.data??s.service_data,s.target);break}case"fire-dom-event":fireEvent(t,"ll-custom",s)}}function csParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(""===e)return"";const i=parseFloat(e);return isNaN(i)||String(i)!==e?null:i}const _TEMPLATE_EXPR_RE=/\{\{(.*?)\}\}/gs,_IDENTIFIER_RE=/[A-Za-z_][A-Za-z0-9_]*/g;function _jinjaLiteral(t){if(null==t)return"''";const e=String(t);return""===e?"''":/^-?\d+(\.\d+)?$/.test(e)||"true"===e||"false"===e?e:`'${e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")}'`}function substitutePhotoVariables(t,e){const i=String(t??"");if(!i.includes("{{")||!e)return{text:i,fullyLiteral:!i.includes("{{")};let o=!0;const s=[];i.replace(_TEMPLATE_EXPR_RE,(t,i)=>{const n=i.trim(),r=/^[A-Za-z_][A-Za-z0-9_]*$/.test(n)&&Object.prototype.hasOwnProperty.call(e,n);return r||(o=!1),s.push({inner:i,isPhotoField:r,field:r?n:null}),t});let n=0;if(o){return{text:i.replace(_TEMPLATE_EXPR_RE,()=>{const{field:t}=s[n++],i=e[t];return null==i?"":String(i)}),fullyLiteral:!0}}return{text:i.replace(_TEMPLATE_EXPR_RE,(t,i)=>`{{${i.replace(_IDENTIFIER_RE,t=>Object.prototype.hasOwnProperty.call(e,t)?_jinjaLiteral(e[t]):t)}}}`),fullyLiteral:!1}}function csTextField(t,e,i,o={}){return html`
  ...
  `;render(){if(!this._config)return html``;const t=this._config;return html`
    ...
    `}_runTransitionAnimations(){if(!this._transitioning)return;const t=this.shadowRoot?.querySelector(".slide-stack");if(!t)return;const e=t.querySelector('.slide-unit[data-role="back"]'),i=t.querySelector('.slide-unit[data-role="front"]');if(!e||!i)return;if(this._animationStartedFor===this._transitionId)return;this._animationStartedFor=this._transitionId,e.getAnimations().forEach(t=>t.cancel()),i.getAnimations().forEach(t=>t.cancel()),e.style.maskImage=e.style.webkitMaskImage="",i.style.maskImage=i.style.webkitMaskImage="";const o=this._config?.transition??"fade",s=1e3*Math.max(0,this._config?.transition_duration??.6),n="ease";if("fade"===o)e.animate([{opacity:1},{opacity:0}],{duration:s,easing:n,fill:"forwards"}),i.animate([{opacity:0},{opacity:1}],{duration:s,easing:n,fill:"forwards"});else if(o.startsWith("slide-")){const t=TRANSITION_EXIT_TRANSFORM[o]??"translateX(-100%)",r=TRANSITION_ENTER_FROM_TRANSFORM[o]??"translateX(100%)";e.animate([{transform:"translate(0,0)"},{transform:t}],{duration:s,easing:n,fill:"forwards"}),i.animate([{transform:r},{transform:"translate(0,0)"}],{duration:s,easing:n,fill:"forwards"})}else if("curtain"===o)e.animate([{clipPath:"inset(0 0 0 0)"},{clipPath:"inset(0 0 0 100%)"}],{duration:s,easing:n,fill:"forwards"}),i.animate([{clipPath:"inset(0 100% 0 0)"},{clipPath:"inset(0 0 0 0)"}],{duration:s,easing:n,fill:"forwards"});else if("clock"===o){i.style.maskImage="conic-gradient(from 0deg, #000 0deg, transparent 0deg)",i.style.webkitMaskImage=i.style.maskImage;const t=60,e=Array.from({length:t+1},(e,i)=>{const o=360*i/t,s=`conic-gradient(from 0deg, #000 ${o}deg, transparent ${o}deg)`;return{maskImage:s,webkitMaskImage:s}});i.animate(e,{duration:s,easing:"linear",fill:"forwards"})}}updated(t){super.updated(t),this._transitioning&&this._runTransitionAnimations()}static styles=css`
    :host {
      display: block;
      height: 100%;
    }
